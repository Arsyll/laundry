...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="modal fade" id="lihatTransaksiDiterima">
                                ...
                                <div class="col-md-12">
                                    <div class="default-tab">
                                        <ul class="nav nav-tabs mb-3">
                                            <li class="nav-item"><a href="#identitas-tab-diterima" class="nav-link identitas-btn-diterima active" data-toggle="tab" aria-expanded="false">Identitas</a>
                                            </li>
                                            <li class="nav-item"><a href="#paket-tab-diterima" class="nav-link paket-btn-diterima" data-toggle="tab" aria-expanded="false">Paket</a>
                                            </li>
                                            <li class="nav-item"><a href="#pembayaran-tab-diambil" class="nav-link pembayaran-btn-diteri" data-toggle="tab" aria-expanded="true">Pembayaran</a>
                                            </li>
                                        </ul>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    <button type="button" class="btn btn-primary btn-block btn-flat font-weight-bold pdf-btn"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak Invoice</button>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="row">
                ...
                <div class="col-md-9" style="margin-top: -10px;">
                    <div class="d-flex justify-content-end">
                        ...
                        <button class="btn btn-flat btn-outline-primary ml-2" id="diambil-btn">Diterima</button>
                    </div>
                </div>
            </div>
		</div>
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		...
                            		<td style="font-size: 16px;" class="text-center">
                            			<button data-toggle="modal" data-target="#lihatTransaksiSelesai" data-lihat="{{ $transaksi->id }}" class="btn btn-sm btn-primary font-weight-bold lihat_selesai">Detail</button>
                                    </td>
                            	</tr>
                            	<?php $number1++ ?>
                            	@endif
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 16px;" class="text-center">
                                        <button data-toggle="modal" data-target="#lihatTransaksiDiantar" data-lihat="{{ $transaksi->id }}" class="btn btn-sm btn-primary font-weight-bold lihat_diantar">Detail</button>
                                    </td>
                                </tr>
                                <?php $number2++ ?>
                                @endif
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 16px;" class="text-center">
                                        <button data-toggle="modal" data-target="#lihatTransaksiDiambil" data-lihat="{{ $transaksi->id }}" class="btn btn-sm btn-primary font-weight-bold lihat_diambil">Detail</button>
                                    </td>
                                </tr>
                                <?php $number3++ ?>
                                @endif
