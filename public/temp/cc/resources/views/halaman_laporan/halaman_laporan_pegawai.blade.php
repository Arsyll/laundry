...
@section('css')
<link href="{{ Public_PATH('plugins/tables/css/datatable/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
<style type="text/css">
	.fotouser{
	    object-fit: cover;
	    width: 3rem;
		                        ...
		                        <table class="table table-striped table-bordered zero-configuration">
		                            ...
		                            <tbody>
		                                ...
		                                <tr>
		                                    ...
		                                    <th><img src="{{ Public_PATH('/pictures/'.$user->avatar) }}" class="rounded-circle mr-3 fotouser" alt="">{{ $user->name }}</th>
...
@endsection
@section('script')
<script src="{{ Public_PATH('plugins/tables/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ Public_PATH('plugins/tables/js/datatable/dataTables.bootstrap4.min.js') }}"></script>
<script src="{{ Public_PATH('plugins/tables/js/datatable-init/datatable-basic.min.js') }}"></script>
@endsection
