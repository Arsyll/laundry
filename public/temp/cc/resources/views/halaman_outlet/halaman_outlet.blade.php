                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-info panggil_hotline" style="color: #fff;"
                                                type="button"><i class="icon-phone"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ url('/tambah_outlet') }}"
                                class="btn mb-1 font-weight-bold btn-sm btn-primary">Tambah Outlet <span
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="dropdown custom-dropdown">
                                                    <div data-toggle="dropdown" style="padding: 5px;"><i
                                                            class="fa fa-ellipsis-v c-primary" style="font-size: 16px;"></i>
                                                    </div>
                                                    <div class="dropdown-menu dropdown-menu-right"><a
                                                            class="dropdown-item lihat_btn" href="#" role="button"
                                                            data-toggle="modal" data-target="#lihatModal"
                                                            data-lihat="{{ $outlet->id }}">Lihat</a>
                                                        <a class="dropdown-item"
                                                            href="{{ url('/edit_outlet/' . $outlet->id) }}">Edit</a>
                                                    </div>
                                                </div>&nbsp;&nbsp;&nbsp;
                                                <a href="{{ url('/hapus_outlet/' . $outlet->id) }}" style="color: grey;"><i
                                                        class="fa fa-trash c-primary" style="font-size: 16px;"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
