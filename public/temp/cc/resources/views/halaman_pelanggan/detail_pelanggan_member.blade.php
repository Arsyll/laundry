                    ...
                    <div class="modal-body">
	                    ...
	                    <div class="row">
	                    	<div class="col-md-12">
	                    		...
	                    		<button type="button" class="pdf-btn btn btn-primary btn-flat font-weight-bold btn-block"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak Invoice</button>
	                    	</div>
	                    </div>
                    </div>
                </div>
						...
						<div class="col-md-12">
							<table class="table" id="table-paket-kiloan">
							  ...
							  <tbody class="body-table-kilo">
							  	...
							  	@php
							  	$checkout_kilos = \App\Models\Checkout_kilo::select('checkout_kilos.*')
							    ...
							    <tr class="table-light">
							      ...
							      <td><button class="btn btn-outline-primary font-weight-bold btn-sm btn-lihat-kilo" data-transaksi="{{ $transaksi->id }}" type="button" data-toggle="modal" data-target="#paketKiloModal">Detail</button></td>
							    </tr>
							    @endif
							    @endforeach
							  </tbody>
							...
							<table class="table" id="table-paket-satuan" hidden="">
							  ...
							  <tbody class="body-table-satu">
							  	@foreach($transaksis as $transaksi)
							  	@php
							  	$checkout_satus = \App\Models\Checkout_satu::select('checkout_satus.*')
							  	->where('kd_invoice', $transaksi->kd_invoice)
							  	->count();
							  	@endphp
							  	@if($checkout_satus != 0)
							    <tr class="table-light">
							      ...
							      <td><button class="btn btn-outline-primary font-weight-bold btn-sm btn-lihat-satu" data-transaksi="{{ $transaksi->id }}" type="button" data-toggle="modal" data-target="#paketSatuModal">Detail</button></td>
							    </tr>
							    @endif
							    @endforeach
							  </tbody>
