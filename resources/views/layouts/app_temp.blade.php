...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/core/menu/menu-types/vertical-menu.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/plugins/extensions/ext-component-toastr.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/vendors/css/extensions/swiper.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/vendors/css/extensions/toastr.min.css">
    <!-- END: Vendor CSS-->
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/pages/app-ecommerce-details.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/plugins/forms/form-number-input.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/template')}}/css/plugins/extensions/ext-component-toastr.css">
    <!-- END: Page CSS-->
