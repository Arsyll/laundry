                                                    ...
                                                    <div class="bs-stepper-content">
                                                            ...
                                                            <form>
                                                                <div class="row align-items-center">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <h4 class="mt-3">Pilih Jenis Laundry</h4>
                                                                        <hr>
                                                                        <div class="form-group">
                                                                            <label class="radio-inline mr-3">
                                                                        ...
                                                                        <div class="alert alert-primary deskripsi-jasa">
                                                                            ...
                                                                            berdasarkan timbangan yang di laundry
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-12 mb-5" id="hal_paket_kiloan">
                                                                        ...
                                                                        <div class="row jenis_paket_error" hidden="">
                                                                            <div class="col-md-12 text-left">
                                                                                <span style='color: red;'>Silakan pilih
                                                                                    paket
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <h4 class="mt-3 mb-3">Metode Pembayaran
                                                                                </h4>
                                                                                <hr>
                                                                                <div class="input-group">
                                                        ...
                                                        <div id="address-step" class="content">
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-lg-4 col-form-label" for="val-password-repeat">Ulangi
                                                                        Password <span class="text-danger">*</span>
                                                                    </label>
                                                                    <div class="col-lg-6">
                                                                        <input type="password" class="form-control" id="val-password-repeat"
                                                                            name="password_repeat" placeholder="Ketik ulang password">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-lg-6 offset-lg-3">
                                                                        <div class="form-check" style="margin-left: 62px;">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox" class="cek_member" name="cek_member"
                                                                                    value="0">&nbsp;&nbsp;Member</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
...
@push('scripts')
    ...
    <script src="{{ asset('cc') }}/js/jquery.form-validator.min.js"></script>
    <script src="{{ asset('cc') }}/plugins/toastr/js/toastr.min.js"></script>
    <script src="{{ asset('cc') }}/plugins/sweetalert/js/sweetalert.min.js"></script>
